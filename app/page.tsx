  ...
  useEffect(() => {
    const processClientSideImage = async () => {
      try {
        ...
        const imageUrl = 'https://hfecpbfntuxaswbitevl.supabase.co/storage/v1/object/sign/images/IMG_E1E4253D346C-1.jpeg?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJpbWFnZXMvSU1HX0UxRTQyNTNEMzQ2Qy0xLmpwZWciLCJpYXQiOjE3MjY5MTAxNTYsImV4cCI6MTcyOTUwMjE1Nn0._r9VdjVkHHyz076v0i_Dn6jZBqcRD5Tt2i3AgcwdgVk&t=2024-09-21T09%3A15%3A56.604Z'
